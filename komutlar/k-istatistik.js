...
exports.run = async (client, message, args) => {
  ...
  const istatistikler = new Discord.MessageEmbed()
    .setColor("BLACK")
    .addField("**__Ping__**",`<a:brave:782028955153858560> Mesaj Gecikmesi: ${new Date().getTime() - message.createdTimestamp} ms\n <a:brave:782028955153858560> Bot Gecikmesi: ${client.ws.ping}ms`, true)
