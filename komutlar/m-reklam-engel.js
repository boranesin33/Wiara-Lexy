...
.setDescription(`Reklam engel sistemi başarıyla bu kanalda kanalda aktif edildi!`)
.setColor('BLACK')
...
.setDescription(`Reklam engel sistemi başarıyla bu kanalda kanalda deaktif edildi!`)
.setColor('BLACK')
